 ...
 * Copyright 2023 WebGPU-Native developers
 */
 ...
 * TODO
 */
typedef void (*WGPUCreateComputePipelineAsyncCallback)(WGPUCreatePipelineAsyncStatus status, WGPU_NULLABLE WGPUComputePipeline pipeline, WGPU_NULLABLE char const * message, void * userdata) WGPU_FUNCTION_ATTRIBUTE;
/**
 * TODO
 */
typedef void (*WGPUCreateRenderPipelineAsyncCallback)(WGPUCreatePipelineAsyncStatus status, WGPU_NULLABLE WGPURenderPipeline pipeline, WGPU_NULLABLE char const * message, void * userdata) WGPU_FUNCTION_ATTRIBUTE;
/**
 * TODO
 */
 ...
 * TODO
 */
typedef void (*WGPURequestAdapterCallback)(WGPURequestAdapterStatus status, WGPU_NULLABLE WGPUAdapter adapter, WGPU_NULLABLE char const * message, void * userdata) WGPU_FUNCTION_ATTRIBUTE;
/**
 * TODO
 */
typedef void (*WGPURequestDeviceCallback)(WGPURequestDeviceStatus status, WGPU_NULLABLE WGPUDevice device, WGPU_NULLABLE char const * message, void * userdata) WGPU_FUNCTION_ATTRIBUTE;
